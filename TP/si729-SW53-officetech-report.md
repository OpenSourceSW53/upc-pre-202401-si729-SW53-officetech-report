...
| **Initial Sprint  Retrospective Summary** | En nuestro Segundo Sprint,  hemos reflexionado sobre el los resultados y correciones del tb1 por lo cual el grupo decicio hacer esas mejoras del tb1 en el TP ademas de planaifcar el fakeapi y la creacion de los componentes para la aplicacion web .  |
| **Sprint Goal & User Stories** |      |
